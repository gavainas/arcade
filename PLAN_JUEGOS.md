...
| 38 | 🔓 | Descifrador Neón | `descifrador-neon.html` | Puzzle de lógica | Mastermind: la máquina esconde un código secreto de colores (con repetidos) y vos lo descifrás a fuerza de intentos, guiado por clavijas de pista (llena = color y posición correctos, hueca = color correcto en el lugar equivocado). 3 dificultades (largo de código, cantidad de colores e intentos), con récord de menos intentos para ganar. | ✅ 2026-09-03 |
