    ...
    onResetEvent: function() {
        ...
        this.dialog = new (me.Renderable.extend({
            ...
            init: function() {
                ...
                // Traducido. Sin tildes: el font del juego no las tiene (ver title.js).
                this.steps = 'PASOS: ' + game.data.steps.toString();
                this.topSteps= 'RECORD: ' + me.save.topSteps.toString();
            },
