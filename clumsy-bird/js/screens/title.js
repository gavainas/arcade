    ...
    onResetEvent: function() {
        ...
        me.game.world.addChild(new (me.Renderable.extend ({
            ...
            init: function() {
                ...
                // Traducido al español. Va en mayúsculas y sin tildes a propósito:
                // el font del juego (data/css/gamefont) tiene 124 glifos y no
                // incluye vocales acentuadas, ñ minúscula ni los signos ¿ ¡.
                this.text = me.device.touch ? 'TOCA PARA EMPEZAR' : 'ESPACIO O CLICK PARA EMPEZAR \n          "M" PARA SILENCIAR';
